...
uses crt;
        type
                pelanggan= record
                ID,nama,alamat,namaPlg,kamar       :string;
...
var
        ...
        begin
                 ...
                 writeln('      || 5.|| jenis kamar : ',Plg[index].kamar,'     ||     ');
                 writeln('      ``=======================================``     ');
                 writeln('------------------------------------------------------');
                 writeln('                                                      ');
        ...
        begin
                clrscr;
                 ...
                 writeln('      ||| |||-------------------------------------------||     ');
                 writeln('      ||===||===========================================||     ');
                 write('        || 1.|| ID         : ');readln(Plg[index].ID                    );
                 write('        || 2.|| Nama       : ');readln(Plg[index].nama                 );
                 write('        || 3.|| Alamat     : ');readln(Plg[index].alamat               );
                 write('        || 4.|| Usia       : ');readln(Plg[index].usia                 );
                 write('        || 5.|| jenis kamar: ');readln(Plg[index].kamar        );
                 write('        ``================================================``     ');
                 writeln('        Apakah anda sudah yakin dengan editan ini ? (Y/N) :     ');
                 readln(YN);
                 repeat
                        if YN = 'y' then
                               editSukses
        ...
        procedure sortOld(Plg : dataPlg; Jml : integer);
        var
                pass, i     : integer;
                temp    : pelanggan;
        begin
...
begin
        ...
        begin
                ...
                writeln('7. Regular      harga= Rp.250000 ');
                 ...
                 write  ('      || 5.|| jenis kamar: ');readln(Plg[i].kamar             );
                 writeln  ('      ``==================================================``     ');
        ...
        begin
                 clrscr;
                        ...
                        writeln('      ``=============================================``     ');
                        writeln('      ||                                             ||     ');
                        writeln('      ||      SILAKAN MASUKAN ID ANDA UNTUK          ||     ');
                        writeln('      ||        UNTUK PENGECEKAN SEBELUM MEMESAN     ||     ');
                        writeln('      ||                                             ||     ');
                        writeln('      ``=============================================``     ');
                        write  ('      Masukan nomor Antrian anda : '); readln(RepID);
